...
call setx /M JFROG_DB_ENCRYPTED_PASSWORD ???
...
call setx /M CONCOURSE_EXTERNAL_URL_1 http://localhost:8083
call setx /M CONCOURSE_EXTERNAL_URL_2 http://localhost:8084
