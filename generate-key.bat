...
FOR /F "tokens=* delims=" %%x in (.\ssh\id_rsa.pub) DO echo git-key-pub-pine-core-java: %%x >> .\ci\concourse\credentials.yml
echo git-key-pine-core-java: ^| >> .\ci\concourse\credentials.yml
